        ...
        <?php
            ...
            if (isset($_POST["telefone"])) {
                ...
                if (strlen($_POST["telefone"]) < 8) {
                    echo "<span class='texto'>O número de telefone que você inseriu é muito curto. Por favor, <a href='formcadastro.html'>volte à página de cadastro</a>.</span>";
                } else {
            ...
            if (strlen($senha) < 8) {
                echo "<span class='texto'>Sua senha é muito curta, volte à <a href='formcadastro.html'>página de cadastro</a> e se cadastre.";
            } elseif (strpos($email, "@") == "") {
